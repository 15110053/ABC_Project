angular.module("EcommerceModule").controller("InprocessOrderProducerController", function ($scope, $mdDialog, $state, OrderPageProducerService){
	$scope.productData;
	$scope.orderData = [];
	var getData = function(callback){
		OrderPageProducerService.getInprocessOrderDetail().then(
			function(response){
